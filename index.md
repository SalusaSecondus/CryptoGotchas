...
* Hashes never provide authenticity.
  ...
  Don't try to incorporate a secret yourself either because it won't work. (Please see [Length Extension Attacks](https://en.wikipedia.org/wiki/Length_extension_attack) and [Flickr's problems with this](https://dl.packetstormsecurity.net/0909-advisories/flickr_api_signature_forgery.pdf)).
